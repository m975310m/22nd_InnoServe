 ...
 */
public class ESUN_SavingAcctDtlInq extends AsyncTask<String, Void, String>
{
...
//            }
            ...
            jsonParam.put("AcctNO",dataControler.ctbcData.getAccData().getJSONObject(0).getString("AcctNO"));
