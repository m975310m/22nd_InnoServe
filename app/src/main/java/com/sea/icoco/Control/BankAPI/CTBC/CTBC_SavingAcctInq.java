 ...
 */
public class CTBC_SavingAcctInq extends AsyncTask<String, Void, String>
{
    ...
    protected String doInBackground(String... strings)
    {
        ...
        try
        {
            String link = "http://52.69.27.105:8080/hackathon/SavingAcctInq";
//            String data = URLEncoder.encode("Token", "UTF-8") + "=" + URLEncoder.encode(Token, "UTF-8");
    ...
    protected void onPostExecute(String result)
    {
        try
        {
            ...
            {
//                Log.d("Debug CTBC BalanceData","result = "+CTBCBalanceData.toString());
                dataControler.ctbcData.setBalance(CTBCBalanceData);
//                dataControler.transactionData.loadTransactionData();
            }
        } catch (JSONException e)
        {
            Log.e("Debug CTBC","ESUN_SavingAcctInq result = "+result);
            Log.e("Debug CTBC","ESUN_SavingAcctInq "+e.toString());
            e.printStackTrace();
        }
    }
}
